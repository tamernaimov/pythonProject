...
def calc():
    ...
    choice = input("Enter exercise1 or try2: ")

    # Validate the choice
    if choice not in ['exercise1', 'try2']:
        print("Invalid choice! Please enter exercise1 for addition or try2 for multiplication.")
